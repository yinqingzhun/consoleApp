...
namespace MyClassLibrary
{
    public partial class DbHelper
    {
        ...
        public object this[string name]
        {
            set
            {
                this[name, System.Data.DbType.Object, ParameterDirection.Input] = value;
            }
            get
            {
                object obj;
        ...
        public object this[string name, System.Data.DbType dbtype]
        {
            set
            {
        ...
        public object this[string name, System.Data.DbType dbType, ParameterDirection direction]
        {
            set
            {
        ...
        /// <returns></returns>
        private DbParameter CreateParameter(string name, object value, System.Data.DbType t = System.Data.DbType.Object, ParameterDirection pDirection = ParameterDirection.Input)
        {
            var para = dbProvider.CreateParameter();
            if (t != System.Data.DbType.Object) para.DbType = t;
        ...
        private T ExecuteScalar<T>(DbCommand cmd)
        {
            try
            {
        ...
        private string getSqlOnly(DbCommand cmd)
        {
            ...
            {
                if (para.DbType == System.Data.DbType.Int16 || para.DbType == System.Data.DbType.Int32 || para.DbType == System.Data.DbType.Int64 || para.DbType == System.Data.DbType.UInt16 || para.DbType == System.Data.DbType.UInt32 || para.DbType == System.Data.DbType.UInt64 || para.DbType == System.Data.DbType.Decimal || para.DbType == System.Data.DbType.Double || para.DbType == System.Data.DbType.Single)
                {
                    sql = sql.Replace(para.ParameterName, para.Value.ToString());
                }
                else if (pSymbol == '@' || para.DbType == System.Data.DbType.AnsiString || para.DbType == System.Data.DbType.String || para.DbType == System.Data.DbType.StringFixedLength)
                {
                    sql = sql.Replace(para.ParameterName, "'" + para.Value.ToString() + "'");
                }
                else if (pSymbol == ':' || para.DbType == System.Data.DbType.DateTime || para.DbType == System.Data.DbType.DateTime2 || para.DbType == System.Data.DbType.DateTimeOffset)
                {
                    //排除未知的时间类型
                    DateTime time;
